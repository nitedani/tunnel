...
var listen = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            netSockets = {};
            tty = (0, tty_1.isatty)(process.stdout.fd);
            ...
            writeStatus = function () {
                ...
                if (socket.connected) {
                    ...
                    if (NET_PORT) {
                        table.push((_b = {},
                            _b[chalk_1.default.white("Forwarding")] = "tcp://".concat(PROVIDER_HOST, ":").concat(NET_PORT, " -> tcp://").concat(TO_HOST, ":").concat(TO_PORT),
                            _b));
                        ...
                        table.push((_c = {},
                            ...
                            _c), (_d = {},
                            _d[chalk_1.default.white("Read")] = (0, pretty_bytes_1.default)(bytesRead),
                            _d), (_e = {},
                            _e[chalk_1.default.white("Written")] = (0, pretty_bytes_1.default)(bytesWritten),
                            _e));
                    }
                }
                else {
            ...
            (0, node_socketio_stream_1.default)(socket).on("tcp_connection", function (_a, socketStream) {
