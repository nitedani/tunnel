...
exports.listen = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            tty = TTY === undefined ? tty_1.isatty(process.stdout.fd) : TTY;
            ...
            writeStatus = function () {
                if (socket.connected) {
                    ...
                    if (reconnecting) {
                        ...
                        console.log(chalk_1.default.red("Disconnected - " + error));
                    }
                }
            };
            ...
            node_socketio_stream_1.default(socket).on("get", function (_a, socketStream) {
                var url = _a.url, headers = _a.headers;
                request_1.default(TO_PROTOCOL + "://" + TO_HOST + ":" + TO_PORT + url, {
                    ...
                    if (isOk) {
                        addLog("GET " + url.substring(0, 80) + " " + chalk_1.default.green(response.statusCode));
                    }
                    else {
                        addLog("GET " + url.substring(0, 80) + " " + chalk_1.default.red(response.statusCode));
                    }
                })
                    .on("error", function (err) {
                    addLog("GET " + url.substring(0, 80) + " " + chalk_1.default.red(err));
                });
            });
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0:
                                _f.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, got_1.default.post(TO_PROTOCOL + "://" + TO_HOST + ":" + TO_PORT + url, {
                                        body: body,
                                        headers: __assign(__assign({}, headers), { host: TO_HOST }),
                                        followRedirect: false,
                                        decompress: false,
                            ...
                            case 1:
                                ...
                                addLog("POST " + url.substring(0, 80) + " " + chalk_1.default.green(response.statusCode));
                                return [3 /*break*/, 3];
                            case 2:
                                err_1 = _f.sent();
                                ...
                                addLog("POST " + url.substring(0, 80) + " " + chalk_1.default.red(((_e = err_1.response) === null || _e === void 0 ? void 0 : _e.statusCode) || "404"));
                                return [3 /*break*/, 3];
