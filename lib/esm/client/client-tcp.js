    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            writeStatus = function () {
                ...
                if (socket.connected) {
                    table.push((_a = {},
                        _a[chalk.white("Status")] = chalk.green("Live"),
                        _a));
                    if (NET_PORT) {
                        table.push((_b = {},
                            _b[chalk.white("Forwarding")] = "tcp://".concat(PROVIDER_HOST, ":").concat(NET_PORT, " -> tcp://").concat(TO_HOST, ":").concat(TO_PORT),
                            _b));
                        ...
                        table.push((_c = {},
                            _c[chalk.white("Connections")] = connectedNetSockets,
                            _c), (_d = {},
                            _d[chalk.white("Read")] = prettybytes(bytesRead),
                            _d), (_e = {},
                            _e[chalk.white("Written")] = prettybytes(bytesWritten),
                            _e));
                    }
                }
                else {
                    if (reconnecting) {
                        table.push((_f = {},
                            _f[chalk.white("Status")] = chalk.yellow("Reconnecting"),
                            _f));
                    }
                    else {
                        table.push((_g = {},
                            _g[chalk.white("Status")] = chalk.red("Disconnected"),
                            _g));
                        if (error) {
                            table.push((_h = {},
                                _h[chalk.white("Error")] = chalk.red(String(error)),
                                _h));
                        }
                    }
                }
            ...
            ss(socket).on("tcp_connection", function (_a, socketStream) {
