...
export var listen = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            socket = io("".concat(IO_PROTOCOL, "://").concat(PROVIDER), {
                query: {
                    room: ROOM,
                },
            });
            ...
            writeStatus = function () {
                if (socket.connected) {
                    ...
                    if (reconnecting) {
                        ...
                        console.log(chalk.red("Disconnected - ".concat(error)));
                    }
                }
            };
            ...
            ss(socket).on("get", function (_a, socketStream) {
                ...
                request("".concat(TO_PROTOCOL, "://").concat(TO_HOST, ":").concat(TO_PORT).concat(url), {
                    ...
                    if (isOk) {
                        addLog("GET ".concat(url.substring(0, 80), " ").concat(chalk.green(response.statusCode)));
                    }
                    else {
                        addLog("GET ".concat(url.substring(0, 80), " ").concat(chalk.red(response.statusCode)));
                    }
                })
                    .on("error", function (err) {
                    addLog("GET ".concat(url.substring(0, 80), " ").concat(chalk.red(err)));
                });
            });
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            case 0:
                                _f.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, got.post("".concat(TO_PROTOCOL, "://").concat(TO_HOST, ":").concat(TO_PORT).concat(url), {
                                        body: body,
                                        headers: __assign(__assign({}, headers), { host: TO_HOST }),
                                        followRedirect: false,
                                        decompress: false,
                            ...
                            case 1:
                                ...
                                addLog("POST ".concat(url.substring(0, 80), " ").concat(chalk.green(response.statusCode)));
                                return [3 /*break*/, 3];
                            case 2:
                                err_1 = _f.sent();
                                ...
                                addLog("POST ".concat(url.substring(0, 80), " ").concat(chalk.red(((_e = err_1.response) === null || _e === void 0 ? void 0 : _e.statusCode) || "404")));
                                return [3 /*break*/, 3];
