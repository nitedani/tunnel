...
export var command = "http [to]";
export var desc = "Start tunnelr http client";
export var builder = {
    room: {
...
export var handler = function (argv) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, import("../client/client-http")];
            case 1:
                listen = (_a.sent()).listen;
                listen(__assign({ PROVIDER: "".concat(argv.room).concat(argv["dot-domain"] ? "-dot-" : ".").concat(argv.provider), ROOM: argv.room, SECURE: argv.secure }, parseTo(argv.to)));
                return [2 /*return*/];
        }
    });
}); };
