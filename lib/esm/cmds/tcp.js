...
export var command = "tcp [to]";
export var desc = "Start tunnelr tcp client";
export var builder = {
    preferredPort: {
...
export var handler = function (argv) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, import("../client/client-tcp.js")];
            case 1:
                listen = (_a.sent()).listen;
                listen(__assign({ PROVIDER: argv.provider, SECURE: argv.secure, PREFERRED_PORT: argv.preferredPort }, parseTo(argv.to)));
                return [2 /*return*/];
        }
    });
}); };
